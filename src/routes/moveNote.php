<?php
$app->post('/api/Evernote/moveNote', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'noteGuid', 'notebookGuid']);
    ...
    try {
        ...
        $responseBody = $client->moveNote($note, $notebook);
